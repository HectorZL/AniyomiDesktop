...
import org.gradle.accessors.dm.LibrariesForComposeCatalog
...
val Project.composeCatalog get() = the<LibrariesForComposeCatalog>()
...
internal fun Project.configureCompose(commonExtension: CommonExtension<*, *, *, *, *, *>) {
    ...
    commonExtension.apply {
        ...
        dependencies {
            "implementation"(platform(composeCatalog.bom))
        }
    }
