...
android {
    ...
    defaultConfig {
        ...
        val traktClientId = System.getenv("TRAKT_CLIENT_ID") ?: localProperties.getProperty("traktClientId", "")
        val traktClientSecret = System.getenv("TRAKT_CLIENT_SECRET") ?: localProperties.getProperty("traktClientSecret", "")
        val tmdbApiKey = System.getenv("TMDB_API_KEY") ?: localProperties.getProperty("tmdbApiKey", "")
